...
\begin{tabular}{p{4cm} p{7.5cm}}
  \lstinline|build(l, r)| & Build an array with indices $[l, r)$. \textbf{Remember to rewind \lstinline|pos| when reusing memory pool!}\\
  \lstinline|access(l, r, pos)| & Access the position with index \lstinline|pos|.\\
  \lstinline|update(l, r, pos, val)| & Change the value at \lstinline|pos| to \lstinline|val|. \\
\end{tabular} \par
